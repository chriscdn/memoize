...
The `Memoize` function prevents duplicate evaluations by ensuring that multiple calls with the same cache key are processed only once. This incluces asynchronous functions.
